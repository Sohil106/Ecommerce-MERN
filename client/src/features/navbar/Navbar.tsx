...
const navigation = [
  { name: "Dashboard", link: `${AllRoutes.Home}`, current: true, user: true },
  { name: "Team", link: `${AllRoutes.Admin}`, current: false, user: true },
  { name: "Admin", link: `${AllRoutes.Admin}`, current: false, admin: true },
  {
    name: "Orders",
...
const userNavigation = [
  { name: "My Profile", link: `${AllRoutes.Profile}` },
  { name: "My Orders", link: `${AllRoutes.Orders}` },
  { name: "Sign out", link: `${AllRoutes.Logout}` },
];
